...
**Προσαρμοσμένα Σενάρια:** Μπορεί να δοθεί σενάριο απευθείας από το command line με μορφή `load_name:dp[:dq[:name]]`, για παράδειγμα `python IEEE39/generate_data.py --scenario "Load 29:2:0"`. Εναλλακτικά μπορεί να χρησιμοποιηθεί το `--case`, για παράδειγμα `python IEEE39/generate_data.py --case "Load 24" 2 0`.
