...
σε κάποιο component/cluster. Οπτικά ανακτά όλες τις εμφανείς συγκεντρώσεις εκτιμήσεων παρόμοια με τον HDBSCAN. Οι αντίστοιχες τιμές silhouette είναι σαφώς μικρότερες καθώς δεν χαρακτηρίζεται καμία εκτίμηση ως θόρυβος και παρουσιάζονται μόνο συμπληρωματικά και δεν αποτελούν κριτήριο επιλογής του μοντέλου. Οι επιλεγμένες τιμές των υπερπαραμέτρων παρουσιάζονται στον Πίνακα~\ref{tab:amb:gmm-tuning}.
...
μεγιστοποιούν το silhouette οδηγούν σε τρείς έως επτά συστάδες. Οι επιλεγμένες τιμές των υπερπαραμέτρων παρουσιάζονται στον Πίνακα~\ref{tab:amb:agglomerative-tuning}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{llrlrr}
        ...
        \midrule
        orders1 & 1 & 0.36 & average & 7 & 0.626 \\
        orders1 & 2 & 0.54 & complete & 4 & 0.685 \\
        orders1 & 3 & 0.73 & complete & 6 & 0.633 \\
        orders2 & 1 & 0.79 & average & 3 & 0.569 \\
        orders2 & 2 & 0.49 & average & 4 & 0.670 \\
        orders2 & 3 & 0.67 & complete & 6 & 0.607 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[p]
    ...
    \begin{tabular}{llr|rrrrrrr}
        ...
        \midrule
        \multirow{3}{*}{orders1} & 1 & 5 & 5 & 5 & 3 & 2 & 4 & 10 & 7 \\
        & 2 & 3 & 4 & 4 & 3 & 2 & 7 & 10 & 4 \\
        & 3 & 6 & 4 & 4 & 2 & 2 & 5 & 10 & 6 \\
        \midrule
        \multirow{3}{*}{orders2} & 1 & 5 & 2 & 2 & 2 & 2 & 9 & 10 & 3 \\
        & 2 & 3 & 5 & 4 & 2 & 2 & 4 & 10 & 4 \\
        & 3 & 6 & 2 & 4 & 3 & 2 & 6 & 9 & 6 \\
        \bottomrule
    \end{tabular}
...
Οι μέθοδοι k-Means, k-Medoids, AHC και GMM αποδίδουν όλες τις
εκτιμήσεις σε συστάδες. Οι πρώτοι τρείς, επιλέγουν από δύο έως επτά συστάδες, πλήθος που
είναι γενικά συγκρίσιμο με τους τρεις έως έξι ρυθμούς αναφοράς των επιμέρους
περιοχών. Αντίθετα, ο GMM , επιλέγει σαφώς μεγαλύτερο πλήθος συστάδων.
...
σημεία σε συστάδες και επιλέγεια
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrrrrrrr}
        ...
        AHC & \textemdash{} & 516 / 0.492 & 333 / 0.608 & \textemdash{} & 65 / 3.431 & 192 / 0.915 & \textemdash{} & 148 / 0.739 & 143 / 1.442 \\
        \bottomrule
    \end{tabular}
    }
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrrrrrrr}
        ...
        AHC & \textemdash{} & 677 / 0.919 & 219 / 2.542 & \textemdash{} & 53 / 3.768 & 165 / 0.963 & \textemdash{} & 134 / 1.325 & 143 / 1.373 \\
        \bottomrule
    \end{tabular}
    }
\end{table}
